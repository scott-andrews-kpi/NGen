...
namespace BlobStorage
{
    ...
    {
        [FunctionName("AddCompanyJobList")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "AddCompanyJobList")] HttpRequest req,
            ILogger log)
        {
            ...
            if (result == null)
            {
                ...
                string env_container = "customerprofile";
